...
const Home = () => {
  ...
  return (
    ...
    <h1 align="center" fontSize="50px">Shop By Category</h1>
    <div style={{display:"flex",margin:"auto",width:"20%", justifyContent:"space-between"}}>
      <p style={{color:"red"}}>Electronics</p>
      <p>Clothing</p>
      <p>Foot Wear</p>
    </div>
...
<h1 align="center"style={{fontWeight:"bold",fontSize:"30px",}}>Best Selling Product</h1>
<div style={{width:"80%", margin:"auto"}}>
<h1 align="center" style={{fontWeight:"bold",paddingTop:"40px",fontSize:"30px"}}>
